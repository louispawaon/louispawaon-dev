...
export default function Header(){
    return(
        <div className="space-y-5 py-20 min-h-[100vh]">
            <div>
                <h1 className="sm:leading-tight lg:leading-tight sm:text-[70px] md:text-[80px] lg:text-[85px] sm:text-4xl font-semibold">hi <Lottie animationData={handWave} className="w-[100px] inline-block"/>,  <span className="font-bold">migs</span> here. </h1>
            </div>
